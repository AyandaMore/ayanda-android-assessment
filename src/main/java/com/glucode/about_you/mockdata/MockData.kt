...
object MockData {
    ...
    fun getEngineersSortedByYears(): List<Engineer> {
        return engineers.sortedBy { it.quickStats?.years }
    }

    fun getEngineersSortedByCoffees(): List<Engineer> {
        return engineers.sortedBy { it.quickStats?.coffees }
    }

    fun getEngineersSortedByBugs(): List<Engineer> {
        return engineers.sortedBy { it.quickStats?.bugs }
    }
}